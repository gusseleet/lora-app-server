...
func (*RegisterUserRequest) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{9} }
...
func (*UserSettings) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{10} }
...
func (*AddUserOrganization) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{13} }
...
func (*UpdateUserRequest) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{14} }
...
func (*ListUserResponse) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{15} }
...
func (*UserEmptyResponse) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{16} }
...
func (*UpdateUserPasswordRequest) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{17} }
...
func (*BrandingRequest) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{18} }
...
func (*BrandingResponse) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{19} }
...
type UserClient interface {
	...
	// Register a user
	Register(ctx context.Context, in *RegisterUserRequest, opts ...grpc.CallOption) (*AddUserResponse, error)
...
func (c *userClient) Register(ctx context.Context, in *RegisterUserRequest, opts ...grpc.CallOption) (*AddUserResponse, error) {
	out := new(AddUserResponse)
	err := grpc.Invoke(ctx, "/api.User/Register", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	// Register a user
	Register(context.Context, *RegisterUserRequest) (*AddUserResponse, error)
	// Get data for a particular user.
...
var fileDescriptor4 = []byte{
	...
	,
}
